...
class SearchFragment : Fragment(R.layout.fragment_search) {
    ...
    private val viewModel: ListViewModel by hiltNavGraphViewModels(R.id.nav_host)
    ...
    private fun subscribeToViewModel() {
        ...
        binding?.etSearch?.apply {
            ...
            if (query == null) {
                ...
                viewModel.getListMovies("search", "multi", query)
    ...
    private fun setupMoveToAnotherFragment() {
        binding?.apply {
            ...
            listAdapter.setOnItemClickListener {
                val type = if (it.name != null) "tv" else "movie"
